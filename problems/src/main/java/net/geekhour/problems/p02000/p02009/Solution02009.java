package net.geekhour.problems.p02000.p02009;
 ...
 * Difficulty: Hard
 * Description: You are given an integer array nums. In one operation, you can
 ...
 * Example 2:
 *
 * Input: nums = [1,2,3,5,6] Output: 1 Explanation: One possible solution is to
 * change the last element to 4. The resulting array is [1,2,3,5,4], which is
 * continuous.
 *
 * Example 3:
 *
 * Input: nums = [1,10,100,1000] Output: 3 Explanation: One possible solution is
 * to: - Change the second element to 2. - Change the third element to 3. -
 * Change the fourth element to 4. The resulting array is [1,2,3,4], which is
 * continuous.
 *
 * Constraints:
 *
...
class Solution02009 {
  ...
  public static void test_02009() {
    Solution02009 solution = new Solution02009();
