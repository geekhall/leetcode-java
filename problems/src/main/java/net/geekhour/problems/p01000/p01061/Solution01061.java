package net.geekhour.problems.p01000.p01061;

/**
 * ID: 01061
 * Title: Lexicographically Smallest Equivalent String
 * Difficulty: Medium
 * Description: You are given two strings of the same length s1 and s2 and a
 * string baseStr.
 *
 ...
 * Output:"aauaaaaada" Explanation: We group the equivalent characters in s1 and
 * s2 as [a,o,e,r,s,c], [l,p], [g,t] and [d,m], thus all letters in baseStr
...
class Solution01061 {
  ...
  public static void test_01061() {
    Solution01061 solution = new Solution01061();
    String result = solution.smallestEquivalentString("parker", "morris", "parser");
    System.out.println(result);
    String result1 = solution.smallestEquivalentString("hello", "world", "hold");
    System.out.println(result1);
    String result2 = solution.smallestEquivalentString("leetcode", "programs", "sourcecode");
    System.out.println(result2);
  }

  public static void main(String[] args) {
    Solution01061.test_01061();
  }
}
