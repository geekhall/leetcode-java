package net.geekhour.problems.p01400.p01488;
 ...
 * Difficulty: Medium
 * Description: Your country has an infinite number of lakes. Initially, all the
 * lakes are empty, but when it rains over the nth lake, the nth lake becomes
 * full of water. If it rains over a lake that is full of water, there will be a
 ...
 * Example 1:
 *
 * Input: rains = [1,2,3,4] Output: [-1,-1,-1,-1] Explanation: After the first
 ...
 * Example 2:
 *
 * Input: rains = [1,2,0,0,2,1] Output: [-1,-1,2,1,-1,-1] Explanation: After the
 ...
 * Example 3:
 *
 * Input: rains = [1,2,0,1,2] Output: [] Explanation: After the second day, full
 * lakes are [1,2]. We have to dry one lake in the third day. After that, it
 * will rain over lakes [1,2]. It's easy to prove that no matter which lake you
