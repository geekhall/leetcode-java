package net.geekhour.problems.p01400.p01472;
 ...
 * Explanation: BrowserHistory browserHistory = new
 * BrowserHistory("leetcode.com"); browserHistory.visit("google.com"); // You
 * are in "leetcode.com". Visit "google.com"
 * browserHistory.visit("facebook.com"); // You are in "google.com". Visit
 * "facebook.com" browserHistory.visit("youtube.com"); // You are in
 * "facebook.com". Visit "youtube.com" browserHistory.back(1); // You are in
...
class BrowserHistory {
  ...
  // define a datastructure to save the history and the current index
  ...
  public void visit(String url) {
    ...
    history = history.entrySet().stream().filter(entry -> entry.getKey() <= index)
  ...
  public static void main(String[] args) {
    ...
    System.out.println(browserHistory.back(7)); // You are in "google.com", you can move back only one step
