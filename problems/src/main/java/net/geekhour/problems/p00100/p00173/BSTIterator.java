package net.geekhour.problems.p00100.p00173;
 ...
 * false] Explanation BSTIterator bSTIterator = new BSTIterator([7, 3, 15, null,
 * null, 9, 20]); bSTIterator.next(); // return 3 bSTIterator.next(); // return
 * 7 bSTIterator.hasNext(); // return True bSTIterator.next(); // return 9
