package net.geekhour.problems.p00100.p00162;

/**
 * ID: 00162
 * Title: Find Peak Element
 * Difficulty: Medium
 * Description: A peak element is an element that is strictly greater than its
 * neighbors.
 *
...
class Solution00162 {
  ...
  public static void test_00162() {
    Solution00162 solution = new Solution00162();
    int[] nums = { 1, 2, 3, 1 };
    int result = solution.findPeakElement(nums);
    System.out.println(result);
    int[] nums2 = { 1, 2, 1, 3, 5, 6, 4 };
    result = solution.findPeakElement(nums2);
    System.out.println(result);
  }

  public static void main(String[] args) {
    Solution00162.test_00162();
  }
}
