package net.geekhour.problems.p00900.p00911;
 ...
 * Difficulty: Medium
 * Description: You are given two integer arrays persons and times. In an
 * election, the i th vote was cast for persons[i] at time times[i].
 *
 ...
 * Example 1:
 *
 * Input ["TopVotedCandidate", "q", "q", "q", "q", "q", "q"] [[[0, 1, 1, 0, 0,
 * 1, 0], [0, 5, 10, 15, 20, 25, 30]], [3], [12], [25], [15], [24], [8]] Output
 * [null, 0, 1, 1, 0, 0, 1] Explanation TopVotedCandidate topVotedCandidate =
 * new TopVotedCandidate([0, 1, 1, 0, 0, 1, 0], [0, 5, 10, 15, 20, 25, 30]);
 * topVotedCandidate.q(3); // return 0, At time 3, the votes are [0], and 0 is
 * leading. topVotedCandidate.q(12); // return 1, At time 12, the votes are
 * [0,1,1], and 1 is leading. topVotedCandidate.q(25); // return 1, At time 25,
 * the votes are [0,1,1,0,0,1], and 1 is leading (as ties go to the most recent
 * vote.) topVotedCandidate.q(15); // return 0 topVotedCandidate.q(24); //
 * return 0 topVotedCandidate.q(8); // return 1
 *
 * Constraints:
 *
...
class TopVotedCandidate {
  ...
  public static void test_00911() {
    ...
    System.out.println(topVotedCandidate.q(25)); // return 1, At time 25, the votes are [0,1,1,0,0,1], and 1 is leading
