package net.geekhour.problems.p00900.p00997;

/**
 * ID: 00997
 * Title: Find the Town Judge
 * Difficulty: Easy
 * Description: In a town, there are n people labeled from 1 to n. There is a
 ...
 *
 * You are given an array trust where trust[i] = [a i, b i ] representing that
 * the person labeled a i trusts the person labeled b i.
 *
