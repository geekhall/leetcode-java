package net.geekhour.problems.p01900.p01901;

/**
 * ID: 01901
 * Title: Find a Peak Element II
 * Difficulty: Medium
 * Description: A peak element in a 2D grid is an element that is strictly
 * greater than all of its adjacent neighbors to the left, right, top, and
 * bottom.
 *
 ...
 * Example 1:
 *
 * Input: mat = [[1,4],[3,2]] Output: [0,1] Explanation: Both 3 and 4 are peak
 * elements so [1,0] and [0,1] are both acceptable answers.
 *
 * Example 2:
 *
 * Input: mat = [[10,20,15],[21,30,14],[7,16,32]] Output: [1,1] Explanation:
