package net.geekhour.problems.p00700.p00707;
 ...
 * Difficulty: Medium
 * Description: Design your implementation of the linked list. You can choose to
 ...
 * linked list.
 * void addAtIndex(int index, int val) Add a node of value val before the index
 * th node in the linked list. If index equals the length of the linked list,
 ...
 * null, null, null, 2, null, 3] Explanation MyLinkedList myLinkedList = new
 * MyLinkedList(); myLinkedList.addAtHead(1); myLinkedList.addAtTail(3);
 * myLinkedList.addAtIndex(1, 2); // linked list becomes 1->2->3
 * myLinkedList.get(1); // return 2 myLinkedList.deleteAtIndex(1); // now the
 * linked list is 1->3 myLinkedList.get(1); // return 3
 *
 * Constraints:
 *
 * 0 <= index, val <= 1000
