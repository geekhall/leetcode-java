package net.geekhour.problems.p01500.p01562;

/**
 * ID: 01562
 * Title: Find Latest Group of Size M
 * Difficulty: Medium
 * Description: Given an array arr that represents a permutation of numbers from
 * 1 to n.
 *
 ...
 * Example 1:
 *
 * Input: arr = [3,5,1,2,4], m = 1 Output: 4 Explanation: Step 1: "00 1 00",
 * groups: ["1"] Step 2: "0010 1", groups: ["1", "1"] Step 3: " 1 0101", groups:
 * ["1", "1", "1"] Step 4: "1 1 101", groups: ["111", "1"] Step 5: "111 1 1",
 * groups: ["11111"] The latest step at which there exists a group of size 1 is
 * step 4.
 *
 * Example 2:
 *
 * Input: arr = [3,1,5,4,2], m = 2 Output: -1 Explanation: Step 1: "00 1 00",
 * groups: ["1"] Step 2: " 1 0100", groups: ["1", "1"] Step 3: "1010 1", groups:
 * ["1", "1", "1"] Step 4: "101 1 1", groups: ["1", "111"] Step 5: "1 1 111",
 * groups: ["11111"] No group of size 2 exists during any step.
 *
 * Constraints:
 *
 * n == arr.length
