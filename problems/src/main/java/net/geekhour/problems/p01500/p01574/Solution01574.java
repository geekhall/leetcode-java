package net.geekhour.problems.p01500.p01574;

/**
 * ID: 01574
 * Title: Shortest Subarray to be Removed to Make Array Sorted
 * Difficulty: Medium
 * Description: Given an integer array arr, remove a subarray (can be empty)
 ...
 * non-decreasing. We do not need to remove any elements.
 *
 * Constraints:
 *
 * 1 <= arr.length <= 10 5
