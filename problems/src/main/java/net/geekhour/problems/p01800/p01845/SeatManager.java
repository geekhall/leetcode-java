package net.geekhour.problems.p01800.p01845;
 ...
 * [], [5]] Output [null, 1, 2, null, 2, 3, 4, 5, null] Explanation SeatManager
 * seatManager = new SeatManager(5); // Initializes a SeatManager with 5 seats.
 * seatManager.reserve(); // All seats are available, so return the lowest
 * numbered seat, which is 1. seatManager.reserve(); // The available seats are
 * [2,3,4,5], so return the lowest of them, which is 2.
