package net.geekhour.problems.p01800.p01802;

/**
 * ID: 01802
 * Title: Maximum Value at a Given Index in a Bounded Array
 * Difficulty: Medium
 * Description: You are given three positive integers: n, index, and maxSum. You
 * want to construct an array nums (0-indexed) that satisfies the following
 * conditions:
 *
 * nums.length == n
 ...
 * Example 1:
 *
 * Input: n = 4, index = 2, maxSum = 6 Output: 2 Explanation: nums = [1,2, 2,1]
 * is one array that satisfies all the conditions. There are no arrays that
 * satisfy all the conditions and have nums[2] == 3, so 2 is the maximum
 * nums[2].
 *
 * Example 2:
 *
