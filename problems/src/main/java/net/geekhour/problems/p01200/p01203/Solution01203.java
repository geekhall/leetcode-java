package net.geekhour.problems.p01200.p01203;
 ...
 * Difficulty: Hard
 * Description: There are n items each belonging to zero or one of m groups
 * where group[i] is the group that the i -th item belongs to and it's equal to
 * -1 if the i -th item belongs to no group. The items and the groups are zero
...
class Solution01203 {
  ...
  public static void test_01203() {
    Solution01203 solution = new Solution01203();
    int n = 8;
