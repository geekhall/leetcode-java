package net.geekhour.problems.p01200.p01282;
 ...
 * Difficulty: Medium
 * Description: There are n people that are split into some unknown number of
...
class Solution01282 {
  ...
  public static void test_01282() {
    Solution01282 solution = new Solution01282();
    int[] groupSizes = { 3, 3, 3, 3, 3, 1, 3 };
    List<List<Integer>> result = solution.groupThePeople(groupSizes);
    System.out.println(result);
    int[] groupSizes1 = { 2, 1, 3, 3, 3, 2 };
