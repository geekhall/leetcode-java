package net.geekhour.problems.p00400.p00436;
 ...
 * Difficulty: Medium
 * Description: You are given an array of intervals, where intervals[i] = [start
 * i, end i ] and each start i is unique.
 *
 * The right interval for an interval i is an interval j such that start j >=
 * end i and start j is minimized. Note that i may equal j.
 *
 ...
 * interval in the collection, so it outputs -1.
 *
 * Example 2:
 *
 ...
 * start 0 = 3 is the smallest start that is >= end 1 = 3. The right interval
 * for [1,2] is [2,3] since start 1 = 2 is the smallest start that is >= end 2 =
 * 2.
 *
 * Example 3:
 *
 ...
 * [3,4] since start 2 = 3 is the smallest start that is >= end 1 = 3.
 *
 * Constraints:
 *
