package net.geekhour.problems.p00400.p00460;
 ...
 * [4]] Output [null, null, null, 1, null, -1, 3, null, -1, 3, 4] Explanation //
 * cnt(x) = the use counter for key x // cache=[] will show the last used order
 * for tiebreakers (leftmost element is most recent) LFUCache lfu = new
 * LFUCache(2); lfu.put(1, 1); // cache=[1,_], cnt(1)=1 lfu.put(2, 2); //
