package net.geekhour.problems.p00400.p00452;
 ...
 * Difficulty: Medium
 * Description: There are some spherical balloons taped onto a flat wall that
 * represents the XY-plane. The balloons are represented as a 2D integer array
 * points where points[i] = [x start, x end ] denotes a balloon whose horizontal
 * diameter stretches between x start and x end. You do not know the exact
 * y-coordinates of the balloons.
 *
 * Arrows can be shot up directly vertically (in the positive y-direction) from
 * different points along the x-axis. A balloon with x start and x end is burst
 * by an arrow shot at x if x start <= x <= x end. There is no limit to the
...
class Solution00452 {
  ...
  public static void test_00452() {
    ...
    int[][] points4 = { { 3, 9 }, { 7, 12 }, { 3, 8 }, { 6, 8 }, { 9, 10 }, { 2, 9 }, { 0, 9 }, { 3, 9 }, { 0, 6 },
        { 2, 8 } };
