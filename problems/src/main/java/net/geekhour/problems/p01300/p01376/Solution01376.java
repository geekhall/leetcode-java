package net.geekhour.problems.p01300.p01376;

/**
 * ID: 01376
 * Title: Time Needed to Inform All Employees
 * Difficulty: Medium
 * Description: A company has n employees with a unique ID for each employee
 * from 0 to n - 1. The head of the company is the one with headID.
 *
...
class Solution01376 {
  ...
  public static void test_01376() {
    Solution01376 solution = new Solution01376();
    int n = 1;
    int headID = 0;
    int[] manager = { -1 };
    int[] informTime = { 0 };
