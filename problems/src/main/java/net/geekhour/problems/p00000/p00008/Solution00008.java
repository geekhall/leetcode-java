package net.geekhour.problems.p00000.p00008;
 ...
 * Difficulty: Medium
 * Description: Implement the myAtoi(string s) function, which converts a string
 ...
 * is read in) ^ The parsed integer is 42. Since 42 is in the range [-2 31, 2 31
 * - 1], the final result is 42.
 *
 * Example 2:
 *
 ...
 * the range [-2 31, 2 31 - 1], the final result is 4193.
 *
 * Constraints:
 *
 * 0 <= s.length <= 200
...
class Solution00008 {
  ...
  public int myAtoi(String s) {
    ...
    int result = 0;
    while (index < len && Character.isDigit(charArray[index])) {
  ...
  public static void test_00008() {
    Solution00008 solution = new Solution00008();
    String s = "42";
    int expected = 42;
    int actual = solution.myAtoi(s);
    System.out.println("Test case 00008: expected: " + expected + ", actual: " + actual);
    s = " -42";
    expected = -42;
