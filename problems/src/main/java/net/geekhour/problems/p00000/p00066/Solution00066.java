package net.geekhour.problems.p00000.p00066;
 ...
 * Title: Plus One
 * Difficulty: Easy
 * Description: You are given a large integer represented as an integer array
 * digits, where each digits[i] is the i th digit of the integer. The digits are
...
class Solution00066 {
  ...
  public static void test_00066() {
    Solution00066 solution = new Solution00066();
    int[] digits = { 9, 9, 9 };
