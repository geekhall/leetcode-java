package net.geekhour.problems.p00000.p00057;
 ...
 * where intervals[i] = [start i, end i ] represent the start and the end of the
 * i th interval and intervals is sorted in ascending order by start i. You are
