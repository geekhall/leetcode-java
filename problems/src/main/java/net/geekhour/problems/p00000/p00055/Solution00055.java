package net.geekhour.problems.p00000.p00055;

/**
 * ID: 00055
 * Title: Jump Game
 * Difficulty: Medium
 * Description: You are given an integer array nums. You are initially
...
class Solution00055 {
  ...
  public static void test_00055() {
    Solution00055 solution = new Solution00055();
    int[] nums = { 2, 3, 1, 1, 4 };
    boolean result = solution.canJump(nums);
    System.out.println(result);
    int[] nums2 = { 3, 2, 1, 0, 4 };
    result = solution.canJump(nums2);
    System.out.println(result);
  }

  public static void main(String[] args) {
    Solution00055.test_00055();
  }
}
