package net.geekhour.problems.p00000.p00012;
...
class Solution00012 {
  ...
  public static void test_00012() {
    Solution00012 solution = new Solution00012();
    int num = 3;
    String expected = "III";
    String actual = solution.intToRoman(num);
    System.out.println("Test case 00012: expected: " + expected + ", actual: " + actual);
    num = 58;
    expected = "LVIII";
