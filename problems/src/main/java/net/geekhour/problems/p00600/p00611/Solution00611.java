package net.geekhour.problems.p00600.p00611;
 ...
 * Difficulty: Medium
 * Description: Given an integer array nums, return the number of triplets
 * chosen from the array that can make triangles if we take them as side lengths
 * of a triangle.
 *
 * Example 1:
 *
