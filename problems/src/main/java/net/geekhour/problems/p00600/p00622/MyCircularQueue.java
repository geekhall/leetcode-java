package net.geekhour.problems.p00600.p00622;

/**
 * ID: 00622
 * Title: Design Circular Queue
 * Difficulty: Medium
 * Description: Design your implementation of the circular queue. The circular
 * queue is a linear data structure in which the operations are performed based
 ...
 * "isFull", "deQueue", "enQueue", "Rear"] [[3], [1], [2], [3], [4], [], [], [],
 * [4], []] Output [null, true, true, true, false, 3, true, true, true, 4]
 * Explanation MyCircularQueue myCircularQueue = new MyCircularQueue(3);
 * myCircularQueue.enQueue(1); // return True myCircularQueue.enQueue(2); //
 * return True myCircularQueue.enQueue(3); // return True
 * myCircularQueue.enQueue(4); // return False myCircularQueue.Rear(); // return
 * 3 myCircularQueue.isFull(); // return True myCircularQueue.deQueue(); //
 * return True myCircularQueue.enQueue(4); // return True
