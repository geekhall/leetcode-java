package net.geekhour.problems.p00600.p00649;
 ...
 * Title: Dota2 Senate
 * Difficulty: Medium
 * Description: In the world of Dota2, there are two parties: the Radiant and
 * the Dire.
 *
 ...
 * Example 1:
 *
 * Input: senate = "RD" Output:"Radiant" Explanation: The first senator comes
 * from Radiant and he can just ban the next senator's right in round 1. And the
 * second senator can't exercise any rights anymore since his right has been
 * banned. And in round 2, the first senator can just announce the victory since
 * he is the only guy in the senate who can vote.
 *
 * Example 2:
 *
 * Input: senate = "RDD" Output:"Dire" Explanation: The first senator comes from
 * Radiant and he can just ban the next senator's right in round 1. And the
 * second senator can't exercise any rights anymore since his right has been
 * banned. And the third senator comes from Dire and he can ban the first
 * senator's right in round 1. And in round 2, the third senator can just
...
class Solution00649 {
  ...
  public static void test_00649() {
    Solution00649 solution = new Solution00649();
    String senate = "RD";
    String result = solution.predictPartyVictory(senate);
    System.out.println(result);
    String senate2 = "RDD";
    String result2 = solution.predictPartyVictory(senate2);
    System.out.println(result2);
  }

  public static void main(String[] args) {
    Solution00649.test_00649();
  }
}
