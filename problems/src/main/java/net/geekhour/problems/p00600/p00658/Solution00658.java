package net.geekhour.problems.p00600.p00658;
 ...
 * Difficulty: Medium
 * Description: Given a sorted integer array arr, two integers k and x, return
 * the k closest integers to x in the array. The result should also be sorted in
 * ascending order.
 *
